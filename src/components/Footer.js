// 공통 클래스 정의
const footerClass = "bg-[#f2f2f2] py-[60px]";
const navClass = "mb-[30px] flex justify-between border-b-2";
...
const textClass = "text-sm text-[#767676] leading-[24px]";
const fontBoldClass = "font-semibold";
...
export default function Footer() {
  ...
  <section class="max-w-container m-auto">
    ...
    <div class="${textClass}">
      <p class="${fontBoldClass}">(주)HODU SHOP</p>
