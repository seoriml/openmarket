...
export default async function Cart() {
  ...
  <div class="bg-[#f2f2f2] mt-[70px] py-[45px] rounded-[10px]">
    <div class="flex items-center text-center">
      ...
      <div class="${priceiconClass}" style="background-image: url('/openmarket/src/images/icon-minus-line.svg'); background-size: 19px;"></div>    
      <div class="${priceItemClass}">
        <p class="${pricetextClass}">상품 할인</p>
        <p><span id="discount" class="${pricenumberClass}">0</span> 원</p>
      </div>
      <div class="${priceiconClass}" style="background-image: url('/openmarket/src/images/icon-plus-line.svg'); background-size: 19px;"></div>
      <div class="${priceItemClass}">
  ...
  <div id="quantity-modal" class="${modalBgClass}">
    <div class="${modalContentClass} absolute flex flex-col items-center">
      ...
      <div class="w-[150px] border border-[#c4c4c4] rounded-[10px] flex items-center justify-center">
        <button id="decrease-quantity" class="${modalButtonSize}" style="background-image: url('/openmarket/src/images/icon-minus-line.svg'); background-size: 20px;"></button>
        <input type="number" id="quantity-input" min="1" class="${modalInputClass}" />
        <button id="increase-quantity" class="${modalButtonSize}" style="background-image: url('/openmarket/src/images/icon-plus-line.svg'); background-size: 20px;"></button>
      </div>
